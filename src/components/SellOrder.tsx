          ...
          <div className="flex  justify-between items-center mt-0.5 mx-1 ">
            <div className="">
              <TabsList className=" flex justify-between bg-transparent ">
                <TabsTrigger
                  value="market"
                  className={`w-1/3 text-[#6E6E6E] data-[state=active]:text-[#EA417F]
                        data-[state=active]:border-b-[#EA417F] rounded-b-none
                        py-3.5
                        `}
                >
                  Market
        ...
        aria-invalid:ring-destructive/20 flex-1  rounded-none border-none "
          ...
          <div className="flex justify-between items-center mx-1">
            <div className="flex flex-nowrap gap-2 justify-evenly items-center p-1.5 my-1.5 text-[#747474] font-medium">
              <span
                className={`px-3 py-0.5 hover:ring-1 hover:border-[#EA417F]  hover:ring-[#EA417F] rounded-md hover:text-[#EDEDED] bg-[#1F1F1F] border border-[#262626]`}
              >
                0.01
              </span>
              <span
          ...
          <div
            className={`flex justify-between items-center mx-1  bg-[#EA417F] my-1 py-1 px-2.5 font-semibold border-[#1F1F1F] rounded-md text-lg`}
          >
          ...
          <div className="flex justify-between items-center text-[#747474] ">
